...
public class MainGenresGetGenreController implements Initializable {
    @FXML
    AnchorPane parent;
    @FXML
    Button btnClose;
    ...
    private void tableFill() throws SQLException {
        ...
        if (resultSet.next()) {
            ...
            text_genre.setText(resultSet.getString("name"));
            genreField.setText(resultSet.getString("name"));
        ...
        ResultSet resultSet= DBController.getMovieFromGenre(temp);
    ...
    public void transferMessage(ResultSet rs) throws SQLException {
        resultSet = rs;
        tableFill();
    }
