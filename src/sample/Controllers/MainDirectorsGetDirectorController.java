...
public class MainDirectorsGetDirectorController implements Initializable {
    @FXML
    AnchorPane parent;
    @FXML
    Button btnClose;
    ...
    private void tableFill() throws SQLException {
        ...
        if (resultSet.next()) {
            ...
            text_director.setText(resultSet.getString("name"));
            ...
            directorField.setText(resultSet.getString("name"));
        ...
        ResultSet resultSet= DBController.getMovieFromDirector(temp);
