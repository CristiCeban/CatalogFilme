...
public class MainActorsAddActorController implements Initializable {
    ...
    private void addActor(){
        btnAddActor.setOnMousePressed(((event)->{
            if(textName.getText().isEmpty()){
                getLabel("Write Star name!");
            }
            else if(textYear.getText().isEmpty()){
                getLabel("Write birthday year of star!");
            }
            else if(textDescription.getText().isEmpty()){
                getLabel("Write something about star!");
            }
            else{
                try {
                    DBController.addStarWithPhoto(textName.getText(),textDescription.getText(),imagePath,Integer.parseInt(textYear.getText()));
                    getLabel("Actor was added!");
